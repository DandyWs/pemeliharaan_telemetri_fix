    ...
    $(document).ready(function (){
      ...
      data.destroy();
        var data = $('#data_detail_componen').DataTable({
            ...
            { data: 'simulasi', name: 'simulasi', sortable: true, searchable: true },
            { data: 'display', name: 'display', sortable: true, searchable: true },
            { data: 'form_komponen_id', name: 'form_komponen_id', sortable: true, searchable: true },
            {   
