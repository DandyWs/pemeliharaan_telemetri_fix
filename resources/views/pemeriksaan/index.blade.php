      ...
      data.destroy();
        var data = $('#data_detail_componen').DataTable({
            ...
            },
            {
                ...
                render: function (data, type, row, meta) {
                    if (row.ttd != null) {
                        return '<a href="{{ url('export-data') }}/'+data+'" class="btn btn-primary btn-sm mr-1 mb-1" ><i class="fa fa-print"></i> </a>'+
                    '<a href="{{ url('pemeriksaan') }}/'+data+'" class="btn btn-info btn-sm mr-1 mb-1"><i class="fa fa-info-circle"></i> </a>';
                    } else {
                        return '<a href="{{ url('pemeriksaan') }}/' + data + '/edit" class="btn btn-success btn-sm mr-1 mb-1"><i class="fa fa-plus"></i> </a>'+
                        '<a href="{{ url('pemeliharaans') }}/'+data+'" class="btn btn-info btn-sm mr-1 mb-1"><i class="fa fa-info-circle"></i> </a>';
                    }
