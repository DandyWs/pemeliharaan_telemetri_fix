      ...
      data.destroy();
        var data = $('#data_detail_componen').DataTable({
            ...
            {   
                ...
                render: function (data, type, row, meta) {
                    return row.ttd ? '<a href="{{ url('pemeriksaan/exportData') }}/'+data+'" class="btn btn-primary btn-sm mt-1" ><i class="fa fa-print"></i> </a>':'<a href="{{ url('pemeliharaans') }}/' + data + '/edit" class="btn btn-warning btn-sm mr-1"><i class="fa fa-edit"></i> </a>' +
