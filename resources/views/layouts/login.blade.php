                ...
                <div class="row justify-content-center align-items-center h-100">
                    <div class="col-12">
                        <div class="header text-center">
                            <img src="https://eoffice.jasatirta1.co.id/domcfg.nsf/logo_jastir1.png" alt="Logo"
                                class="img-fluid mx-auto d-block mb-4" width="200" height="200">
                            <h4>Sign In <br>
                        ...
                        <div class="login-form">
                            <form action="{{url('/login')}}" method="post">
                                ...
                                <input type="email" class="form-control @error('email') is-invalid @enderror"
                                    id="floatingInput" placeholder="Masukkan email anda"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mt-3">
                            ...
                            <input class="form-control @error('email_register') is-invalid @enderror"
                                name="email_register" id="email" placeholder="Masukkan email anda" required>
