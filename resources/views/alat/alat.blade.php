    ...
    <div class="card">
        <div class="card-header border-0">
          <div class="d-flex justify-content-between">
           <h3 class="card-title"><b>Daftar Lokasi Alat</b></h3>
          </div>
          <div class="card-body">
            <div class="row d-flex justify-between" style="width: 100%; justify-content: space-between; align-items: center; margin: 0">
              <a href="{{url('alat/create')}}" class="btn -btn sm btn-success my-2">Tambah Data</a>
    ...
    $(document).ready(function (){
      ...
      data.destroy();
        var data = $('#data_detail_componen').DataTable({
            ...
            { data: 'lokasiStasiun', name: 'lokasiStasiun', sortable: true, searchable: true },
            { data: 'jenisAlat', name: 'jenisAlat', sortable: true, searchable: true },
            {   
                data: 'id', name: 'id', searchable: false, sortable: false,
                render: function (data, type, row, meta) {
                    return '<a href="{{ url('alat') }}/' + data + '/edit" class="btn btn-warning btn-sm mr-1"><i class="fa fa-edit"></i> </a>' +
                        '<button class="btn btn-danger btn-sm btn-delete" data-id="' + data + '"><i class="fa fa-trash"></i> </button>' +
                    `<a href="{{url('/alat/')}}/` + data +`"class="btn btn-sm btn-primary "><i class="fas fa fa-info-circle"></i></a>`;
                }
                }
            ]
        });
